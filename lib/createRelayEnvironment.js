...
// Really slow. Optimize if having perf issues.
function compress(query) {
  var newLineCompressed = query.replace(/\n/g, " ");
  var spaceCompressed = newLineCompressed.replace(/\s+/g, " ");
  return spaceCompressed;
}
